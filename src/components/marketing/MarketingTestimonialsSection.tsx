  ...
  const testimonials = [
    {
      ...
      rating: 5,
      text: "Using PASTA framework, my client's ROAS jumped from 1.5x to 4.2x in just 3 weeks! The templates are gold."
    },
    {
      name: "Sarah Lim",
      ...
      rating: 5,
      text: "AIDA framework helped me write product descriptions that convert 3x better. Revenue increased by 180%!"
    },
    {
      name: "David Chen",
      role: "Course Creator",
      ...
      rating: 5,
      text: "STAR method transformed my sales pages. From 2% to 12% conversion rate using these exact templates!"
    }
  ];
          ...
          {testimonials.map((_, i) => (
            <button
              ...
              className={`w-3 h-3 rounded-full transition-colors ${
                i === selectedTestimonial ? 'bg-green-600' : 'bg-slate-300'
              }`}
