        ...
        >
          ...
          <div className="bg-white/10 rounded-2xl p-8 mb-8 backdrop-blur-sm">
            <div className="text-center">
              <div className="text-slate-400 line-through text-lg mb-2">Regular: $5,994</div>
          ...
          <div className="space-y-4">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="w-full bg-orange-500 hover:bg-orange-600 text-white font-bold py-4 px-8 rounded-xl text-lg transition-colors flex items-center justify-center group"
            >
