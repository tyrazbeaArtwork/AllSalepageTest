...
const FreelanceActionSection = () => {
  return (
    <>
      <section className="py-20 px-6 bg-gradient-to-r from-slate-900 to-teal-900">
          ...
          >
            ...
            <div className="bg-white/10 rounded-2xl p-8 mb-8 backdrop-blur-sm">
              <div className="text-center">
                <div className="text-slate-200 line-through text-lg mb-2">Regular: $3,994</div>
            ...
            <div className="space-y-4">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="w-full bg-gradient-to-r from-teal-500 to-cyan-500 hover:from-teal-600 hover:to-cyan-600 text-white font-bold py-4 px-8 rounded-xl text-lg transition-colors flex items-center justify-center group"
              >
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 p-4 bg-gradient-to-r from-teal-600 to-cyan-600 shadow-lg">
        <div className="max-w-md mx-auto">
          <motion.button
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
            className="w-full bg-white text-teal-700 font-bold py-3 px-6 rounded-full text-lg shadow-lg hover:shadow-xl transition-all flex items-center justify-center group"
          >
