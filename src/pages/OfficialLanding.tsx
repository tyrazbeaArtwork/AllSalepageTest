  ...
  return (
    <div className="min-h-screen bg-white dark:bg-convrt-dark-blue overflow-hidden">
      ...
      <main className="pt-16">
        {/* Simplified Hero Section - Only "See How It Works" Button */}
        <section className="relative min-h-[60vh] pt-20 pb-16 overflow-hidden bg-[#F9F6F3]">
          <div className="container-section relative z-10">
            ...
            >
              <motion.div
                ...
                className="mb-8"
              >
                <a href="#how-it-works" className="button-outline font-inter text-lg px-8 py-4">
                  See How It Works
                </a>
              </motion.div>
            </motion.div>
