          ...
          <div className="container mx-auto px-6 relative z-10">
            ...
            >
              ...
              >
                ...
                >
                  <div className="w-16 h-16 rounded-full bg-convrt-cyan/10 flex items-center justify-center mb-4">
                    <svg className="w-8 h-8 text-convrt-influential" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <footer className="relative overflow-hidden bg-gradient-to-b from-white to-convrt-light-gray/30 py-16">
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            >
              <a href="#" className="text-gray-600 hover:text-convrt-influential transition-colors">Privacy</a>
              <a href="#" className="text-gray-600 hover:text-convrt-influential transition-colors">Terms</a>
              <a href="#" className="text-gray-600 hover:text-convrt-influential transition-colors">Contact</a>
            </motion.div>
          </div>
        </div>
      </footer>
